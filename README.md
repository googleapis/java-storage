...
```Groovy
implementation platform('com.google.cloud:libraries-bom:2.30.2')
...
```Groovy
implementation 'com.google.cloud:google-cloud-storage:2.30.2'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-storage" % "2.30.2"
```
