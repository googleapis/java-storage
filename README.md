...
<dependency>
    <groupId>com.google.cloud</groupId>
    <artifactId>google-cloud-storage-control</artifactId>
    <version>2.38.0</version><!-- {x-version-update:google-cloud-storage:released} -->
</dependency>
```
...
```Groovy
implementation 'com.google.cloud:google-cloud-storage-control:2.38.0' <!-- {x-version-update:google-cloud-storage:released} -->
```
