...
public class StorageLayoutName implements ResourceName {
  private static final PathTemplate PROJECT_BUCKET =
      PathTemplate.createWithoutUrlEncoding("projects/{project}/buckets/{bucket}/storageLayout");
  ...
  public static StorageLayoutName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_BUCKET.validatedMatch(
            formattedString, "StorageLayoutName.parse: formattedString not in valid format");
  ...
  public static List<StorageLayoutName> parseList(List<String> formattedStrings) {
    List<StorageLayoutName> list = new ArrayList<>(formattedStrings.size());
