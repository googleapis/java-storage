...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 66: {
            ...
            acl_.add(
                input.readMessage(com.google.storage.v2.BucketAccessControl.parser(), extensionRegistry));
            break;
          }
          case 74: {
          ...
          case 210: {
            ...
            customPlacementConfig_ = input.readMessage(com.google.storage.v2.Bucket.CustomPlacementConfig.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public interface IamConfigOrBuilder extends
     ...
     * </pre>
     *
     * <code>.google.storage.v2.Bucket.IamConfig.PublicAccessPrevention public_access_prevention = 2;</code>
  ...
  private static final long serialVersionUID = 0L;
     ...
     * @return The publicAccessPrevention.
     */
    @java.lang.Override public com.google.storage.v2.Bucket.IamConfig.PublicAccessPrevention getPublicAccessPrevention() {
      @SuppressWarnings("deprecation")
      com.google.storage.v2.Bucket.IamConfig.PublicAccessPrevention result = com.google.storage.v2.Bucket.IamConfig.PublicAccessPrevention.valueOf(publicAccessPrevention_);
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (publicAccessPrevention_ != com.google.storage.v2.Bucket.IamConfig.PublicAccessPrevention.PUBLIC_ACCESS_PREVENTION_UNSPECIFIED.getNumber()) {
    ...
    public static final class Builder extends
        ...
        if (uniformBucketLevelAccessBuilder_ == null) {
          if (uniformBucketLevelAccess_ != null) {
            uniformBucketLevelAccess_ =
              com.google.storage.v2.Bucket.IamConfig.UniformBucketLevelAccess.newBuilder(uniformBucketLevelAccess_).mergeFrom(value).buildPartial();
          } else {
            uniformBucketLevelAccess_ = value;
          }
          onChanged();
       ...
       */
      @java.lang.Override
      public com.google.storage.v2.Bucket.IamConfig.PublicAccessPrevention getPublicAccessPrevention() {
        @SuppressWarnings("deprecation")
        com.google.storage.v2.Bucket.IamConfig.PublicAccessPrevention result = com.google.storage.v2.Bucket.IamConfig.PublicAccessPrevention.valueOf(publicAccessPrevention_);
        return result == null ? com.google.storage.v2.Bucket.IamConfig.PublicAccessPrevention.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setPublicAccessPrevention(com.google.storage.v2.Bucket.IamConfig.PublicAccessPrevention value) {
        if (value == null) {
          throw new NullPointerException();
        }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              ...
              rule_.add(
                  input.readMessage(com.google.storage.v2.Bucket.Lifecycle.Rule.parser(), extensionRegistry));
              break;
            }
            default: {
              if (!parseUnknownField(
      ...
      public static final class Builder extends
        ...
        public Builder mergeAction(com.google.storage.v2.Bucket.Lifecycle.Rule.Action value) {
          if (actionBuilder_ == null) {
            if (action_ != null) {
              action_ =
                com.google.storage.v2.Bucket.Lifecycle.Rule.Action.newBuilder(action_).mergeFrom(value).buildPartial();
            } else {
              action_ = value;
            }
            onChanged();
        ...
        public Builder mergeCondition(com.google.storage.v2.Bucket.Lifecycle.Rule.Condition value) {
          if (conditionBuilder_ == null) {
            if (condition_ != null) {
              condition_ =
                com.google.storage.v2.Bucket.Lifecycle.Rule.Condition.newBuilder(condition_).mergeFrom(value).buildPartial();
            } else {
              condition_ = value;
            }
            onChanged();
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(
        ...
        try {
          ...
          parsedMessage = (com.google.storage.v2.Bucket.CustomPlacementConfig) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder mergeVersioning(com.google.storage.v2.Bucket.Versioning value) {
      if (versioningBuilder_ == null) {
        if (versioning_ != null) {
          versioning_ =
            com.google.storage.v2.Bucket.Versioning.newBuilder(versioning_).mergeFrom(value).buildPartial();
        } else {
          versioning_ = value;
        }
        onChanged();
    ...
    public Builder mergeEncryption(com.google.storage.v2.Bucket.Encryption value) {
      if (encryptionBuilder_ == null) {
        if (encryption_ != null) {
          encryption_ =
            com.google.storage.v2.Bucket.Encryption.newBuilder(encryption_).mergeFrom(value).buildPartial();
        } else {
          encryption_ = value;
        }
        onChanged();
    ...
    public Builder mergeBilling(com.google.storage.v2.Bucket.Billing value) {
      if (billingBuilder_ == null) {
        if (billing_ != null) {
          billing_ =
            com.google.storage.v2.Bucket.Billing.newBuilder(billing_).mergeFrom(value).buildPartial();
        } else {
          billing_ = value;
        }
        onChanged();
    ...
    public Builder mergeIamConfig(com.google.storage.v2.Bucket.IamConfig value) {
      if (iamConfigBuilder_ == null) {
        if (iamConfig_ != null) {
          iamConfig_ =
            com.google.storage.v2.Bucket.IamConfig.newBuilder(iamConfig_).mergeFrom(value).buildPartial();
        } else {
          iamConfig_ = value;
        }
        onChanged();
