...
public final class RewriteObjectRequest extends com.google.protobuf.GeneratedMessageV3
  ...
  public int getSerializedSize() {
    ...
    if (destinationPredefinedAcl_
        != com.google.storage.v2.PredefinedObjectAcl.PREDEFINED_OBJECT_ACL_UNSPECIFIED
            .getNumber()) {
      size += com.google.protobuf.CodedOutputStream.computeEnumSize(6, destinationPredefinedAcl_);
    }
    if (((bitField0_ & 0x00000001) != 0)) {
    ...
    if (commonRequestParams_ != null) {
      size +=
          com.google.protobuf.CodedOutputStream.computeMessageSize(20, getCommonRequestParams());
    }
    if (!copySourceEncryptionKeyBytes_.isEmpty()) {
      size +=
