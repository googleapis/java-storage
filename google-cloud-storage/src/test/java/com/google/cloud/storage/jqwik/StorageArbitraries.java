...
public final class StorageArbitraries {
  ...
  public static final class Objects {
    ...
    /**
     * Arbitrary for {@link com.google.storage.v2.ObjectCustomContextPayload}.
     */
      ...
      return Combinators.combine(
          ...
          .as(
              (value, createTime, updateTime) -> {
                ObjectCustomContextPayload.Builder builder = ObjectCustomContextPayload
    ...
    /**
     * Arbitrary for {@link com.google.storage.v2.ObjectContexts}.
     */
    public Arbitrary<ObjectContexts> objectContexts() {
      Arbitrary<String> key = alphaString().ofMinLength(1).ofMaxLength(32);
      Arbitrary<Map<String, ObjectCustomContextPayload>> customMap = Arbitraries
          .maps(key, objectCustomContextPayload()).ofMinSize(0).ofMaxSize(5);

      return customMap
          .map(
              c -> ObjectContexts.newBuilder().putAllCustom(c).build())
          .injectNull(0.5);
    }
  }
