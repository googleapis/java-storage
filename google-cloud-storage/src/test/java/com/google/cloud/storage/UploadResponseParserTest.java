...
public final class UploadResponseParserTest {
  ...
  public void testParse() throws IOException {
    ...
    UploadPartResponse uploadPartResponse = UploadResponseParser.parse(response);
  ...
  public void testExtractHashesFromHeader() throws IOException {
    ...
    Map<String, String> hashes = UploadResponseParser.extractHashesFromHeader(response);
