...
class OpenTelemetryInstance implements OpenTelemetryTraceUtil {
  ...
  static class Span implements OpenTelemetryTraceUtil.Span {
    ...
    @Override
    public OpenTelemetryTraceUtil.Span setAttribute(String key, int value) {
      return null;
    }

    @Override
    public OpenTelemetryTraceUtil.Span setAttribute(String key, String value) {
      return null;
    }

    @Override
    public OpenTelemetryTraceUtil.Span setAttribute(String key, boolean value) {
      return null;
    }
  ...
  @Override
  public Span startSpan(String methodName) {
  ...
  private SpanBuilder addSettingsAttributesToCurrentSpan(SpanBuilder spanBuilder) {
    ...
    spanBuilder = spanBuilder.setAllAttributes(
        Attributes.builder().put("gcp.client.version", GaxProperties.getLibraryVersion(this.getClass()))
