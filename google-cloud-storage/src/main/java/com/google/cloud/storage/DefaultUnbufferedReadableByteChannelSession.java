...
final class DefaultUnbufferedReadableByteChannelSession<R, S>
  ...
  private final ApiFunction<S, UnbufferedReadableByteChannel> f;
  private final SettableApiFuture<R> resultFuture;

  private volatile ApiFuture<UnbufferedReadableByteChannel> channel;

  public DefaultUnbufferedReadableByteChannelSession(
      S s, BiFunction<S, SettableApiFuture<R>, UnbufferedReadableByteChannel> f) {
  ...
  @Override
  public ApiFuture<UnbufferedReadableByteChannel> openAsync() {
    if (channel == null) {
