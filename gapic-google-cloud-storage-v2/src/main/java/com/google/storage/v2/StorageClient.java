 ...
 *    <tr>
 *      <td>GetIamPolicy</td>
 *      <td><p> Gets the IAM policy for a specified bucket or object. The `resource` field in the request should be `projects/_/buckets/{bucket}` for a bucket or `projects/_/buckets/{bucket}/objects/{object}` for an object.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td>SetIamPolicy</td>
 *      <td><p> Updates an IAM policy for the specified bucket or object. The `resource` field in the request should be `projects/_/buckets/{bucket}` for a bucket or `projects/_/buckets/{bucket}/objects/{object}` for an object.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
